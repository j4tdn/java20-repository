...
VALUES  (1,	'Áo 1',			'Chất Liệu 1',	195	, 'Trắng', 		1),
		(2,	'Áo 2',			'Chất Liệu 2',	185	, 'Đen',		1),
		(3,	'Giày 1',		'Chất Liệu 3',  175,  'Trắng',		3),
		(4,	'Giày 2', 		'Chất Liệu 4',  165,  'Đen',		3),
		(5,	'Giày 3', 		'Chất Liệu 1',  155,  'Trắng', 	    3),
		(6,	'Mũ 1',			'Chất Liệu 2',  284,  'Đen',		5),
		(7,	'Mũ 2',			'Chất Liệu 3',  268,  'Trắng',      5),
		(8,	'Dép 1', 		'Chất Liệu 4',  252,  'Đen',   	    4),
...
VALUES  (1,	'Địa chỉ 1',	20,	str_to_date('7/9/23 22:05',	'%d/%m/%Y %H:%i'), 	1, 1,	1),
		(2,	'Địa chỉ 2',	20,	str_to_date('7/7/23 22:05',	'%d/%m/%Y %H:%i'), 	1, 1,	2),
		(3,	'Địa chỉ 3',	20,	str_to_date('7/8/23 22:05',	'%d/%m/%Y %H:%i'),	 1, 2,	3),
		(4,	'Địa chỉ 4',	30,	str_to_date('15/2/23 22:05', '%d/%m/%Y %H:%i'),	 2, 3, 4),
		(5,	'Địa chỉ 5',	30,	str_to_date('15/2/23 22:05', '%d/%m/%Y %H:%i'), 	3, 2, 2),
		(6,	'Địa chỉ 6',	20,	str_to_date('7/9/23 22:05',	'%d/%m/%Y %H:%i'),	1,	3,	5),
		(7,	'Địa chỉ 7',	40,	str_to_date('12/12/23 22:05','%d/%m/%Y %H:%i'),  2,	4,	1),
		(8,	'Địa chỉ 8',	20,	str_to_date('7/9/23 22:05',	'%d/%m/%Y %H:%i'),	3,	5,	2),
		(9,	'Địa chỉ 9',	50,	str_to_date('7/9/23 22:05',	'%d/%m/%Y %H:%i'),	3,	2,	3),
		(10, 'Địa chỉ 10',	20, str_to_date('7/9/23 22:05',	'%d/%m/%Y %H:%i'),	2,	2,	5),
		(11, 'Địa chỉ 11',	10,	str_to_date('6/9/23 22:05','%d/%m/%Y %H:%i'),	2,	1,	4),
		(12, 'Địa chỉ 12',	20,	str_to_date('7/9/23 22:05',	'%d/%m/%Y %H:%i'),	1,	1,	3);

-- SELECT str_to_date('15/09/2022 12:05', '%d/%m/%Y %H:%i') `datetime`;
...
VALUES (1,1,4,2),(2,1,31,5),(3,1,49,1),
(4,1,68,2),(5,2,39,2),(6,2,48,2),
(7,2,50,12),(8,2,53,3),(9,3,21,2),(10,3,22,2),
(11,3,39,2),(12,3,49,11),(13,4,11,2),
(14,4,41,3),(15,4,46,3),(16,4,69,3),
(17,5,5,3),(18,5,24,2),(19,5,39,8),
(20,5,56,8),(21,6,10,2),(22,6,23,9),
(23,6,29,3),(24,6,30,11),(25,7,17,2),
(26,7,43,15),(27,7,54,10),(28,7,57,5),(29,8,8,20),
(30,8,18,7),(31,8,59,2),(32,8,65,9),
(33,9,29,10),(34,9,34,1),(35,9,38,7),
(36,9,53,2),(37,10,22,10),(38,10,24,10),
(39,10,40,2),(40,10,50,2),(41,11,37,2),
(42,11,38,2),(43,11,48,11),(44,11,51,2),
(45,12,1,12),(46,12,29,2),(47,12,35,1),(48,12,42,3);
...
SELECT od.ID ORDER_ID,
	   ...
	   FLOOR(1 +  rand() * (SELECT MAX(ID) FROM EMPLOYEE)),
...
SELECT ID, current_timestamp(), 0, ID
 FROM `ORDER`
ORDER BY ID;
