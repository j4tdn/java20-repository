...
/**
 * Builder pattern is a construction pattern + build/create complex objects (has
 * many attributes) + build out an of immutable(impossible to update data at
 * HEAP) object + create one construction process replace for many
 * representations (many overload constructors)
 * 
 * + students(100 elements H1) --> students(point > 7) --> immutable object +
 * remove point <= 7 students(70 elements H1) --> dữ liệu gốc bị changed
 * 
 * + immutable . create many constructors with enough parameters required a, b
 * a, c a, b, c --> too many constructors --> cannot create duplicate
 * constructor with same data type & amount
 * 
 * ==> builder pattern --> create just one construction to create an immutable
 * object
 */
...
public class BuilderPatternDemo {
	public static void main(String[] args) {
		...
		System.out.println("ua1 address: " + System.identityHashCode(ua1));
		ua1.firstName("Hoang Updated");
		System.out.println("ua1 --> " + ua1);
		System.out.println("ua1 address: " + System.identityHashCode(ua1));

		UserHigherAdv uha1 = UserHigherAdv.of().firstName("Teo").lastName("Le").age(18);
