...
public class Exercises03 {
	...
	public static void main(String[] args) {
		Exercises03 test = new Exercises03();
        String pattern = "dd/MM/yyyy";

        System.out.println("1.Xem thời gian hiện tại(dd/MM/yyy HH:mm:ss) ở khu vực bất kỳ. " + test.getCurDateTime(pattern + " HH:mm:ss"));
        System.out.println("2.In ngày cuối cùng của tháng hiện tại (dd/MM/yyyy). " + test.getLastDayInCurMonth(pattern));
        System.out.println("3.Xem ngày đầu tiên và cuối cùng của tuần hiện tại. " + Arrays.toString(test.getFirstAndLastDaysInCurWeek(pattern)));
        System.out.println("4.Xem ngày hiện tại đang ở tuần thứ mấy trong năm. " + test.getCurWeekInYear());
        System.out.println("5.Kiểm tra sau 20 ngày nữa là ngày nào, thứ mấy. " + test.checkDateAfter20Days(20, pattern + " EEEE"));
        System.out.println("6.Nhập vào ngày tháng năm sinh. Kiểm tra xem bạn đã sống được bao nhiêu ngày. " + test.calculateDaysAlive(pattern));
    }
    ...
    public String calculateDaysAlive(String pattern) {
        ...
        return "Bạn đã sống được " + daysAlive + " ngày.";
    }
}
