...
public class CollectionUtils {
	...
	public static <K,V> void generateItems(String prefix, Map<K,V> map) {
	...
	//VÌ: trong hàm remove mđ đang duyệt từng pt xem có equals -> xóa nhưng mặc định compare địa chỉ
