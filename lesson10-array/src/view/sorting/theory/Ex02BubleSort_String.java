...
public class Ex02BubleSort_String {
	...
	public static void main(String[] args) {
		...
		/*
		  Với KDL đối tượng(có sẵn của Java như Integer, String, Double), so sánh dùng compareTo từ interface cha Comparable<T>
		  Giá trị của các phần tử có thể bị NULL
		  
		  An toàn: NULL check trước khi so sách dùng compareTo
