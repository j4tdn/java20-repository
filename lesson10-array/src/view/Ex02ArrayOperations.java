...
public class Ex02ArrayOperations {
	...
	*/
	...
	public static void main(String[] args) {
		...
		generate("Tìm những phần tử là số lẻ trong mảng", getOddNumbers(numbers));

		generate("Tìm những phần tử là số chẵn trong mảng", getEvenNumbers(numbers));
		
		generate("Tìm những phần tử là số nguyên tố trong mảng", getPrimeNumbers(numbers));
