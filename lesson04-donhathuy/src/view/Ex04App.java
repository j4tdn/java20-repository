...
public class Ex04App {
	public static void main(String[] args) {
		...
		Manager hrManager = new Manager ("Đỗ Văn Sang",LocalDate.of(2000, 12, 3), 3.1, 2.1, "HR" );
		Manager salesManager = new Manager ("Đỗ Văn Tùng",LocalDate.of(2001, 6, 3), 3.4, 2.5, "Sales" );
		Staff st01 = new Staff ("Nguyễn Ngọc Linh", LocalDate.of(2003, 5, 3), 2.5, "HR", hrManager);
		Staff st02 = new Staff ("Trần Gia Hân", LocalDate.of(2003, 6, 3), 2.5, "HR", hrManager);
		Staff st03 = new Staff ("Nguyễn Văn Tuấn", LocalDate.of(2003, 6, 23), 2.4, "HR", hrManager);
		Staff st04 = new Staff ("Nguyễn Thanh Lan", LocalDate.of(2002, 6, 7), 2.3, "Sales", salesManager);
		Staff st05 = new Staff ("Nguyễn Thanh Huy", LocalDate.of(2001, 9, 23), 2.5, "Sales", salesManager);
		Staff st06 = new Staff ("Nguyễn Ngọc Anh", LocalDate.of(2000, 12, 9), 2.7, "Sales", salesManager);
