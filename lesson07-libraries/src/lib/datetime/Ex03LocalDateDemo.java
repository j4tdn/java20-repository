...
public class Ex03LocalDateDemo {
	public static void main(String[] args) {
		...
		LocalDate ldate = LocalDate.now().withDayOfMonth(5).withMonth(6).withYear(2023);
		System.out.println("ldate --> " + format(ldate, "dd/MM/yyyy"));

		System.out.println();

		LocalDate anotherDate = LocalDate.now().withDayOfMonth(4).withMonth(7).withYear(2023);
		...
		System.out.println("period toString --> " + opt(period.getYears(), "year") + opt(period.getMonths(), "month")
