...
public class HibernateCacheDao extends BaseHibernateDao implements CacheDao {
	...
	public void firstLevelCache() {
		...
		// hạn chế dùng, dùng khi muốn đảm bảo 100% lấy từ database, k quan tâm đến cache
		// s2.evict(group2);
		// s2.clear();
	...
	public void secondLevelCache() {
		...
		ItemGroup group5 = s3.get(ItemGroup.class, 1); // get from db -> store into 1st, 2nd cache
