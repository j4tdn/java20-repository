...
public class Ex04OperationWithAll {

	public static void main(String[] args) {
		
		/*
		   Từ JAVA10: Thay vì khai báo KDL cho biến thì mình sẽ dùng từ khoá 'var'
		...
		list1.addAll(listB);
		generateInts("list1 add all", list1);

		var list2 = new ArrayList<>(listA);
		list2.removeAll(listB);
		generateInts("list2 remove all", list2);
		
		var list3 = new ArrayList<>(listA);
		list3.retainAll(listB);
		generateInts("list3 retain all", list3);
